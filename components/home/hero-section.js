...
export const HeroSection = () => (
  <section className="mt-12 flex md:flex-row flex-col-reverse  gap-6 justify-between items-center pr-12">
    <div>
      <h1 className="mb-3 text-3xl font-serif font-medium text-orange-400">Intro</h1>
      <p className="max-w-225 text-4xl font-medium md:text-4xl/12">
    ...
    <div className="relative w-75 h-75 mr-6 flex items-center justify-center">
